	...
	const modalContent = (
		...
		>
			...
			>
				...
				<div className="p-6">
					<h5 className="mb-3 text-2xl font-bold text-white pr-12">{title}</h5>
					...
					<div className="flex flex-col gap-4 mt-6 pt-4 border-t border-white/10">
						...
						{/* View Project Button and Close Button for Mobile */}
						<div className="flex gap-3 sm:hidden">
							{href && (
								<a
									...
									className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2 bg-gradient-to-r from-[#915eff] to-[#7a57db] text-white rounded-lg hover:from-[#7a57db] hover:to-[#915eff] transition-all duration-300 transform hover:scale-105 text-sm font-medium"
								>
									View Project
									<svg
										className="w-4 h-4"
							...
							<button
								onClick={closeModal}
								className="w-1/5 px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-lg transition-colors duration-200 font-medium border-2 border-red-500 text-sm text-center flex items-center justify-center"
							>
								Close
							</button>
						</div>

						{/* View Project Button for Desktop */}
						{href && (
